...
from polyeval_extra.target.guilescheme.value import GuileSchemeTargetValue
...
class GuileSchemeTargetTests(BaseTargetTests):
    def __init__(self):
        self.naming = GuileSchemeTargetNaming()
        self.type = GuileSchemeTargetType()
        self.value = GuileSchemeTargetValue()
